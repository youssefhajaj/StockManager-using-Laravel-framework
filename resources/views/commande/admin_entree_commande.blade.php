    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form style="text-align: center;width:138px;margin:auto;display:flex;justify-content:center;" id="edit-form" action="{{Route('AC-update')}}" method="POST"> 
            @csrf
            ...
            <div style="display: flex;width:100%;">
                ...
                <input style="border: none;width: 50px;text-align:center;" type="text" name="quantite" id="quantite">
