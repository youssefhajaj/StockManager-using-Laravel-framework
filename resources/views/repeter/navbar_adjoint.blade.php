...
<body style="background-color: rgb(224, 224, 224);">
   ...
   <nav>
      <div class="sidebar-top">
        ...
        <a class="hide bell" href="{{route('adjoint.notification')}}">
      ...
      <div class="sidebar-links">
        <ul>
          ...
          <li style="margin-top: 20px;" class="tooltip-element" data-tooltip="0">
            <a href="{{route('adjoint.dashboard')}}" @yield('dashboard-active') data-active="0">
              <div class="icon">
          ...
          <li class="tooltip-element dropdownmenu" data-tooltip="1">
            <a href="{{route('produit.adjoint.index')}}" @yield('produit-active') data-active="1">
              <div class="icon">
            ...
            <li class="tooltip-element dropdownmenu" data-tooltip="1">
              ...
              <div class="dropdown">
                <div style="background:#1f2027" class="links dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{route('produit.adjoint.index.consommable')}}">Consommable</a>
                  <a class="dropdown-item" href="{{route('produit.adjoint.index.industriel')}}">Industriel</a>
                  <a class="dropdown-item" href="{{route('produit.adjoint.index.bureautique')}}">Bureautique</a>
                </div>
              </div>
            </li>
            ...
            {{-- **************************************** --}}
            <li class="tooltip-element dropdownmenu" data-tooltip="1">
              <a href="{{route('adjoint.fournisseur')}}" @yield('fournisseur-active') data-active="1">
                <div class="icon">
            ...
            {{-- **************************************** --}}
            <li class="tooltip-element dropdownmenu" data-tooltip="1">
              <a href="{{route('adjoint.stock')}}" @yield('stock-active') data-active="1">
                <div class="icon">
            ...
            {{-- **************************************** --}}
            <li class="tooltip-element dropdownmenu" data-tooltip="1">
              <a href="{{route('adjoint.client')}}" @yield('client-active') data-active="1">
                <div class="icon">
            ...
            <li class="tooltip-element dropdownmenu" data-tooltip="1">
              ...
              <div class="dropdown">
                <div style="background:#1f2027" class="links dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="{{route('adjoint.commande.entree')}}">Entrée</a>
                  <a class="dropdown-item" href="{{route('adjoint.commande.sortie')}}">Sortie</a>
                </div>
              </div>
            </li>
            ...
            {{-- **************************************** --}}
          <li class="tooltip-element dropdownmenu" data-tooltip="1">
            <a href="{{route('adjoint.profile')}}" @yield('profile-active') data-active="1">
              <div class="icon">
