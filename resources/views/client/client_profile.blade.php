...
<div class="container rounded bg-white mt-2 mb-2">
   <div class="row">
       <div class="col-md-6 border-right">
        <h4 class="text-center mt-5">Profile</h4>
       ...
       <div class="col-md-6 border-right">
           <div class="p-2 py-6">
               ...
               <form action="{{ url('edit-profile') }}" method="POST">
                  ...
                  <div class="row mt-3">
                     <div class="col-md-12"><label class="labels">Telephone</label>               <input type="number" id="telephone" name="telephone" class="form-control  @error('telephone') is-invalid @enderror" placeholder="Entrer votre Telephone" value="{{ Auth::user()->telephone }}"></div>
